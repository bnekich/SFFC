...
<form action="{{ route('intake.store') }}" method="POST">
    ...
    <div class="grid grid-cols-4 gap-6">
        ...
        <div class="flex items-center">
            ...
            <input id="can_text_reminder" type="checkbox" name="can_text_reminder" value="0"
                class="sffc-checkbox" {{ old('can_text_reminder') ? 'checked' : '' }}>
        ...
        <div class="flex items-center">
            ...
            <input id="can_email_reminder" type="checkbox" name="can_email_reminder" value="0"
                class="sffc-checkbox" {{ old('can_email_reminder') ? 'checked' : '' }}>
            ...
            <div class="flex flex-col">
                <label class="flex items-center sffc-label">
                    <input type="radio" name="requested_service" value="host"
                        {{ old('requested_service') === 'host' ? 'checked' : '' }} class="sffc-label">
                    <span class="ml-2">Requesting Host Family</span>
                </label>

                <label class="flex items-center sffc-label">
                    <input type="radio" name="requested_service" value="friend"
                        {{ old('requested_service') === 'friend' ? 'checked' : '' }} class="sffc-label">
        ...
        <div class=" col-span-4">
            ...
            <div id="referral_organization" class="border border-gray-400 p-2 rounded-md">
                <div>
                    {{-- <label for="referral_organization" class="sffc-label">Name</label> --}}
                    <input id="referral_organization" type="text" name="referral_organization"
                ...
                <div>
                    {{-- <label for="referral_contact" class="sffc-label">Contact</label> --}}
                    <input id="referral_contact" type="text" name="referral_contact"
                ...
                <div>
                    {{-- <label for="referral_organization_phone" class="sffc-label">Phone</label> --}}
                ...
                <div>
                    {{-- <label for="referral_organization_email" class="sffc-label">Email</label> --}}
    ...
    <div>
        ...
        @else
            <a href="{{ route('home') }}" class="sffc-btn-cancel">Cancel</a>
        @endauth
    </div>
</form>
@endsection
