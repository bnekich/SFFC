...
@section('content')
    ...
    <form class="row g-3 align-items-center" action="{{ route('case.store') }}" method="POST">
        ...
        <div class="col-auto">
            ...
            <select id="status" name="status" class="form-select-sm @error('status') is-invalid @enderror">
        ...
        <div class="col-auto">
            <label for="start_date" class="form-label">Case Open Date</label>
        ...
        <div class="mb-3">
            ...
            <textarea id="case_description" name="case_description" class="form-control">{{ old('case_description') }}</textarea>
        </div>
        <div class="col-2">
