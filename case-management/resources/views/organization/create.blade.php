...
<form class="row g-3 align-items-center" action="{{ route('organization.store') }}" method="POST">
    ...
    <div class="col-auto">
        ...
        <select name="organization_type_id" class="form-select-sm @error('organization_type_id') is-invalid @enderror"
            required>
    ...
    <div class="col-auto">
        ...
        <input type="text" name="contact_person_title" id="contact_person_title" placeholder="Contact Person Title"
    ...
    <div class="col-auto">
        ...
        <input type="text" name="contact_person_email" id="contact_person_email" placeholder="Contact Person Email"
    ...
    <div class="col-auto">
        ...
        <input type="text" name="contact_person_phone" id="contact_person_phone" placeholder="Contact Person Phone"
