    ...
    public function run(): void
    {
        ...
        $organizations = [
            [
                ...
                'organization_type_id' => $organizationTypes->where('name', 'Non-Profit')->first()->id,
                'address_id' => 1,
            ...
            [
                ...
                'organization_type_id' => $organizationTypes->where('name', 'Church Partner')->first()->id,
            ...
            [
                'name' => 'Generac',
                'organization_type_id' => $organizationTypes->where('name', 'For-Profit')->first()->id,
                'address_id' => 1,
                'created_by' => 1,
                'updated_by' => 1,
            ],
            [
                ...
                'organization_type_id' => $organizationTypes->where('name', 'Government')->first()->id,
                'address_id' => 1,
                'created_by' => 1,
                'updated_by' => 1,
            ],
            [
                ...
                'organization_type_id' => $organizationTypes->where('name', 'Educational')->first()->id,
                'address_id' => 1,
                'created_by' => 1,
                'updated_by' => 1,
            ],
            [
                ...
                'organization_type_id' => $organizationTypes->where('name', 'Healthcare')->first()->id,
                'address_id' => 1,
                'created_by' => 1,
                'updated_by' => 1,
            ],
